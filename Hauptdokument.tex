...
\chapter{Beispiele}
\label{cha:beispiele}
	Dieses Kapitel soll viele alltägliche Beispiele\footnote{Fußnote} abdecken um einen {\LaTeX} Dokument zu setzen
		...
		\label{sec:schriftarten} 
			\begin{itemize}
				...
				\item Ausführungszeichen: ``Das ist ein Beispiel''
				\item asld
			\end{itemize}
